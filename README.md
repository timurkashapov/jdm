...
- Для реализации модели состояний системы какие структуры данных или типы применять ?
    - класс _extends_ java.util.Observable можно применить если в коде используются наблюдатели.
- Как хранить константные значения для проекта ?
- Как кашерно дебажить многопоточность и java.util.Thread в частнсти ?
